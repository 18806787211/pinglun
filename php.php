...
if(mysqli_connect_errno($connect))//没连上的时候
	...
	$fanhui=mysqli_query($connect,"insert into content_table (content,time) values ('$content','$time')");
	if($fanhui)
	{
		$json=array('content'=>$content,'time'=>$time);
